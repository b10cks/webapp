...
export { default as SheetHeaderCombined } from './SheetHeaderCombined.vue'
...
export const unobstrusiveSheetContentVariants = cva(
  'bg-background shadow-lg border-border pointer-events-auto',
  {
    variants: {
      side: {
        right:
          'flex h-full border-l inset-y-0 right-0 h-full data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right',
      },
    },
    defaultVariants: {
      side: 'right',
